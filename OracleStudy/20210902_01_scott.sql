...
SELECT TO_DATE('2021-12-28 18:00:00','YYYY-MM-DD HH24:MI:SS') - SYSDATE * (하루를 구성한느 전체 초)
FROM DUAL;
...
SELECT TRUNC(TRUNC(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60)/60)/24) "일"
     , MOD(TRUNC(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60)/60),24) "시"
     , MOD(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60),60) "분"
     , MOD(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60)),60) "초"
FROM DUAL;

SELECT SYSDATE "현재 시각"
     , TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS') "태어난 시각"
     , TRUNC(TRUNC(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60)/60)/24) "일"
     , MOD(TRUNC(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60)/60),24) "시"
     , MOD(TRUNC(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60))/60),60) "분"
     , MOD(((SYSDATE - TO_DATE('1994-12-31 14:03:00','YYYY-MM-DD HH24:MI:SS')) * (24*60*60)),60) "초"
FROM DUAL;
...
SELECT CASE WHEN F OR T THEN '범석만세'
            ...
            END "결과 확인"
FROM DUAL;
IF, ELSE IF 처럼... 첫번째 WHEN이 TRUE 면 ... 두 번째 WHEN 은 실행되지 않는 건가요???
결과가 나오면 뒤에는 연산안하는..
*/
